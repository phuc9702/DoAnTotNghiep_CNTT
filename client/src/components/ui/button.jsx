...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap gap-3 rounded-md text-sm font-bold ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-stone-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-stone-950 dark:focus-visible:ring-stone-300",
  {
    variants: {
      variant: {
        default: "bg-main text-secondary hover:bg-main/90 dark:bg-blue-50 dark:text-stone-900 dark:hover:bg-blue-50/90",
        destructive:
        ...
        main: "bg-blue-600 text-stone-50 hover:bg-blue-600/90",
      },
      size: {
